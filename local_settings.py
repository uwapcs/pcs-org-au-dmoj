...
INSTALLED_APPS += (
        ...
        # NOTE: ALWAYS INCLUDE THE TRAILING COMMA FOR A 1-TUPLE OTHERWISE IT'LL BE REDUCED TO A STRING
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'dmoj',
        'USER': 'dmoj',
        'PASSWORD': get_docker_secret('mysql_password'),
        'HOST': 'mysql',
        'OPTIONS': {
            'charset': 'utf8mb4',
...
EMAIL_HOST_PASSWORD = get_docker_secret('gmail_password')
EMAIL_PORT = 587
...
SERVER_EMAIL = 'PCS Online Judge <noreply@pcs.org.au>'
...
SITE_LONG_NAME = 'PCS Online Judge'
